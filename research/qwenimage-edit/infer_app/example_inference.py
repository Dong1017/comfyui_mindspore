...
def main():
    ...
    transformer = QwenImageTransformer2DModel.from_pretrained(
        args.model_id, subfolder="transformer", mindspore_dtype=ms.float32
    )
    vae = AutoencoderKLQwenImage.from_pretrained(args.model_id, subfolder="vae", mindspore_dtype=ms.float16)
    text_encoder = Qwen2_5_VLForConditionalGeneration.from_pretrained(
        args.model_id, subfolder="text_encoder", mindspore_dtype=ms.float16
    )
